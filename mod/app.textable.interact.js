(function() {
    ...
    globalThis.Terminal = function(text, placeholder, to) {
        ...
        defPh = ph.getAttribute('data-placeholder')
    ...
    globalThis.setPlaceholder = function(content = null) {
        ph.setAttribute('data-placeholder', content ?? defPh)
    }
